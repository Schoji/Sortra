...
const FileSquare = ({ id, order, fileName, fileSize, isDragging }: FileSquareProps) => {
    ...
    return (
        <motion.div
            ...
            whileTap={{ scale: 0.98 }}>
            <div className={`rounded-md shadow-sm text-left bg-base-100 hover:bg-base-100-50 cursor-grab p-2 grid grid-cols-[min-content_min-content_1fr] items-center gap-1 ${isDragging ? "opacity-0" : "opacity-100"}`}
